...
export function ProjectCard({ project, featured = false }: { project: Project; featured?: boolean }) {
  ...
  return (
    <article className={`portfolio-card overflow-hidden border border-slate-200 bg-white transition hover:-translate-y-1 hover:shadow-soft ${featured ? "lg:col-span-2" : ""}`}>
